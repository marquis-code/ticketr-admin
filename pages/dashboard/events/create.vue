      ...
      <div class="glass-card rounded-2xl p-4 sm:p-6 md:p-8 border-primary/30">
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Event Banner Upload -->
            <div class="md:col-span-2">
              <label class="block text-xs font-medium text-gray-600 mb-2">Event Banner / Carousel Images</label>
              <input 
                type="file" 
                multiple
                accept="image/*" 
              ...
              />
              <p class="text-[10px] text-gray-400 mt-2">Upload one or more high-quality images for your event.</p>
              
              <!-- Previews -->
              <div v-if="bannerPreviewUrls.length > 0" class="mt-4">
                <p class="text-xs font-medium text-gray-600 mb-2">Selected Images:</p>
